...
import { SettingsSection, SettingsRow, SettingsInput, SettingsSelect, SettingsToggle } from "../ui";
import { SystemSettings } from "../../types";
import { ExternalLink, CheckCircle, XCircle, Loader2 } from "lucide-react";
import { InlineStatus, StatusType } from "@/components/ui/InlineStatus";
import { api } from "@/lib/api";

interface TidalSectionProps {
...
export function TidalSection({ settings, onUpdate, onTest, isTesting }: TidalSectionProps) {
    ...
    return (
        <SettingsSection
            id="tidal"
            title="TIDAL"
            description="Download high-quality music directly from TIDAL"
        >
            <SettingsRow
                label="Enable TIDAL"
                description="Use TIDAL as a download source"
                htmlFor="tidal-enabled"
            >
                <SettingsToggle
                    id="tidal-enabled"
                            ...
                            {authState === "polling" && authUrl && (
                                <p className="text-xs text-white/60">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-[#ecb200] hover:underline break-all"
                                    >
                                        {authUrl}
                                    </a>
                                </p>
                        ...
                        description={
                            <div className="space-y-2">
                                ...
                                <details className="text-xs">
                                    <summary className="cursor-pointer text-[#ecb200] hover:underline select-none">
